...
First download the latest version of Moonlibs (prebuilt dlls) from [here](https://moonside.games/files/moonlibs.tar.gz) and unzip the moonlibs folder into the root directory of this repository.
...
You will then need to run the ContentBuilderUI project first. This will generate the content files necessary to build and run the game.
...
If you get errors complaining that the fonts aren't initialized, go back to the content builder and try rebuilding the fonts to make the errors go away
